...
import type {
  ...
  IFunctionsCoordinatorInterface,
} from "../IFunctionsCoordinator";
...
export class IFunctionsCoordinator__factory {
  static readonly abi = _abi;
  static createInterface(): IFunctionsCoordinatorInterface {
    return new Interface(_abi) as IFunctionsCoordinatorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IFunctionsCoordinator;
  }
}
